...
class BlurViewModel(application: Application) : ViewModel() {
    ...
    // class variable for a WorkManager instanc.
...
//
        ...
        val save = OneTimeWorkRequestBuilder<SaveImageToFileWorker>()
            ...
            //tag the work, to get the WorkInfo.
            .addTag(TAG_OUTPUT)
            .build()
    ...
    //input and output is passed in & out via Data objects.
    ...
    private fun createInputDataForUri(): Data {
        ...
        //if imageUri is a non-null URI,
        // add it to Data object using the putString method.
        imageUri?.let {
